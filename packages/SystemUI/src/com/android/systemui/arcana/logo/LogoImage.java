...
package com.android.systemui.arcana.logo;
...
public abstract class LogoImage extends ImageView {
    ...
    public void updateLogo() {
        ...
        switch(mLogoStyle){
            case 0:
                drawable = mContext.getResources().getDrawable(R.drawable.ic_arcana_logo);
                break;
            case 1:
            ...
            case 32:
                ...
                break;
            case 33:
                drawable = mContext.getResources().getDrawable(R.drawable.peachy_icon);
                break;
            case 34:
                drawable = mContext.getResources().getDrawable(R.drawable.rice_icon);
                break;
        }
